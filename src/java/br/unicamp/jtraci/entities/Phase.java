...
public class Phase extends Entity {		
	...
	/**
	 * The phase definition differs for 0x25 and 0x2b. The first (0x25) contains the old, 
	 * deprecated definition which uses three strings that describe the tl's state, the first green y/n, 
	 * the second for brake y/n, the third for yellow y/n. The second (0x2b) contains a single string 
	 * representing the lights. Note, that the first (0x25) is also reversed.
	 * 
	 * red light -> 'r'                        
